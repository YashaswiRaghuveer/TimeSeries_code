...
All data are in ASCII column format with extension .txt.

The files that generate Figure x in the paper have been labelled figurex.m
for x= 2,3,4,5,6,7,8. To replicate these figures, load the files, type figure5, 
...
Additional data used inconstructing the second-stage estimates for India CPI, 
US Stock Price Index and Real Gold Prices are in indiacpi.txt, stocks.txt 
and goldprices.txt, respectively.
